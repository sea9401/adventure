...
export function BattleScene({
  ...
  return (
    <div className="space-y-4">
      ...
      <div
        ref={logRef}
        className="max-h-72 space-y-0.5 overflow-y-auto rounded-lg border border-zinc-200 bg-white/90 p-4 text-[15px] leading-6 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden dark:border-zinc-800 dark:bg-zinc-950/90"
      >
