...
// BattleView pre-screen 의 "자동 사냥 (1시간 원정)" 카드.
    ...
    return (
      <Card padding="md">
        ...
        <p className="mt-1 text-[11px] text-zinc-500 dark:text-zinc-400">
          현재 지역으로 캐릭터를 1시간 동안 사냥 보냅니다. 보고 있지 않아도 자동 포션 규칙대로
          진행되며, 1시간 뒤 받기 버튼으로 그동안의 결과를 한 번에 받습니다 (조기 수령 가능).
