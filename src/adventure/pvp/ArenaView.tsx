...
import { Sword, Trophy, WarningCircle } from "@phosphor-icons/react";
import { Card } from "@/components/ui/Card";
import { EmptyState } from "@/components/ui/EmptyState";
import { Skeleton } from "@/components/ui/Skeleton";
import { useArena, type ChallengeResponse } from "./useArena";
  ...
  return (
    <div className={`rounded-md border p-3 text-sm ${tone}`}>
      ...
      <details className="mt-2">
        ...
        <ol className="mt-2 max-h-64 space-y-0.5 overflow-y-auto pl-1 text-[11px] text-zinc-600 dark:text-zinc-300">
          {result.log
...
function Leaderboard({
  ...
  return (
    <Card as="section" padding="sm">
      <h3 className="mb-2 flex items-center gap-1.5 text-xs font-medium text-zinc-700 dark:text-zinc-200">
