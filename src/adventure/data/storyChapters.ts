...
export type StoryChapter = {
  /** 정수 순서. UI 정렬 키. */
  number: number;
  /** 1~5 — 막. UI 그룹화. 5막은 「빈 옥좌의 시대」(Ch 25 직후 후일담). */
  act: 1 | 2 | 3 | 4 | 5;
  /** 짧은 챕터 제목. */
  title: string;
