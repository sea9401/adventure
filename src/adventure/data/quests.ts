...
export const QUESTS: Quest[] = [
  ...
  },
  {
    ...
    description:
      "포션을 단 한 병도 꺼내지 말고 별을 지키는 자를 두 번 거두시오. 흔들리지 않는 자세가 별빛에 새겨질 때까지.",
    requiredLevel: 70,
    target: { kind: "no_potion_boss", monsterName: "별을 지키는 자", count: 2 },
    reward: { fame: 50 },
    repeatable: false,
    giverNpcId: "star_haven_elder",
    requiresQuestCompleted: "star-haven-corridor-golems",
  ...
  },
  {
    ...
    description:
      "포션을 단 한 병도 꺼내지 말고 천공인의 왕을 두 번 거두시오. 폐도는 견디는 자만이 풀어낼 수 있다.",
    requiredLevel: 80,
    target: { kind: "no_potion_boss", monsterName: "천공인의 왕", count: 2 },
    reward: { fame: 60 },
    repeatable: false,
    giverNpcId: "star_haven_elder",
    requiresQuestCompleted: "star-haven-skyfolk-gate",
  ...
  },
  {
    ...
    description:
      "포션을 단 한 병도 꺼내지 말고 창공의 주재를 두 번 거두시오. 옥좌를 견디는 자만이 별빛의 끝을 본다.",
    requiredLevel: 90,
    target: { kind: "no_potion_boss", monsterName: "창공의 주재", count: 2 },
    reward: { fame: 80 },
    repeatable: false,
    giverNpcId: "star_haven_elder",
    requiresQuestCompleted: "star-haven-apex-gate",
