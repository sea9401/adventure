...
export const ITEMS = {
  ...
  starlight_lens: {
    ...
    description: "별빛 정찰자가 한쪽 눈에 끼우고 있던 별빛 렌즈. 손에 쥐면 어깨가 비는 만큼 별의 자리가 또렷이 보인다.",
    rarity: "unique",
    tradable: false,
    tier: 5,
  } satisfies EquipItem,
  corridor_string: {
    ...
    description: "회랑 정찰자가 별빛 결을 한 가닥 더 매어 둔 활. 시위에 닿으면 어깨 위 무게가 사라진다.",
    rarity: "unique",
    tradable: false,
    tier: 5,
  } satisfies EquipItem,
  ...
  ruin_scout_sandals: {
    ...
    description: "폐도 정찰병이 신고 다녔다는 가벼운 별빛 짚신. 신으면 어깨가 휑한 만큼 발이 살아난다.",
    rarity: "unique",
    tradable: false,
    tier: 5,
  } satisfies EquipItem,
  ruin_phantom_blade: {
    ...
    description: "폐도 정찰병이 환영처럼 휘둘렀다는 가벼운 칼. 손에 들면 어깨가 비는 만큼 발이 한 박자 먼저 떨어진다.",
    rarity: "unique",
    tradable: false,
    tier: 5,
  } satisfies EquipItem,
  ...
  skyfolk_greatsword: {
    ...
    description: "옛 천공의 골렘이 한 손에 들고 있던 양손검. 두 손으로도 무겁지만, 한 번 휘두르면 별이 떨어진다.",
    rarity: "unique",
    tradable: false,
    tier: 5,
  } satisfies EquipItem,
  road_flash_dagger: {
    ...
    description: "길의 정찰관이 옥좌의 길에서 다듬은 가느다란 단검. 손에 닿으면 어깨가 비고 끝이 살아난다.",
    rarity: "unique",
    tradable: false,
    tier: 5,
  } satisfies EquipItem,
  ...
  throne_pursuer_sandals: {
    ...
    description: "옥좌의 호위가 신고 옥좌 둘레를 돌았다는 가벼운 짚신. 신으면 어깨가 비고 발이 살아난다.",
    rarity: "unique",
    tradable: false,
    tier: 5,
  } satisfies EquipItem,
  ...
  throne_starbook: {
    ...
    description: "봉인된 황좌 골렘이 옛 황성에서 두고 떠난 별책. 손에 쥐면 어깨가 비고 별의 결이 손가락에 흐른다.",
    rarity: "unique",
    tradable: false,
    tier: 5,
  } satisfies EquipItem,
